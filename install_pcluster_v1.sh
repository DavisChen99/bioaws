...
base_os = alinux
custom_ami = ami-0ab8a54fbf54abb1f   # change to your customized AMI based on pcluster ami(eg. ami-0ab8a54fbf54abb1f [cn-northwest-1]/ ami-02d8c4f46ddaa963f [cn-north-1])
